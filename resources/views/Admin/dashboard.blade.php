...
@section('Subcontent')
    <div class="">
        <div class=" border-2 p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="flex mt-20 mb-20 items-center justify-center h-48 mb-4 rounded  dark:bg-gray-800">
                <div class="grid md:grid-cols-2 gap-20">
                    <div class="container flex ml-10 justify-start items-center">
                        <img class="w-80 h-80 mb-3 object-cover rounded-full shadow-lg" src="../images/Funny Dog Videos.jpg" alt="Bonnie image">
                    </div>
                    
                    <div class="w-full text-left bg-gray-50 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                        <h5 class="mb-4 mt-10 text-3xl font-bold text-gray-900 dark:text-white">{{ Auth::user()->name }}</h5>
                        ...
                        <div class="container flex flex-col justify-center items-center">
                            <div class="container mb-4 flex flex-wrap items-center">
                                ...
                                <h5 class="ml-2 text-gray-900 dark:text-white">IDUSR{{ Auth::user()->id }}</h5>
                            </div>
                            <div class="container mb-4 justify-start flex flex-wrap items-center">
                                ...
                                <h5 class="ml-2 text-gray-900 dark:text-white">{{ ucwords(Auth::user()->role) }}</h5>
                            </div>
                            <div class="container mb-3 flex flex-wrap items-center">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                ...
                                <h5 class="ml-2 text-gray-900 dark:text-white">{{ Auth::user()->email }}</h5>
                            </div>
                            <div class="container flex mb-3 flex-wrapitems-center">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                ...
                                <h5 class="ml-2 text-gray-900 dark:text-white">{{ Auth::user()->created_at }}</h5>
                            </div>
                        </div>
                    </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div
                ...
                <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">Discover the seamless
                    process of creating a new course with ease!</h1>
