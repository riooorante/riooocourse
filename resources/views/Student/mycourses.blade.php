    ...
    <div class="container flex flex-wrap mx-auto mt-10 mb-10 justify-center items-center">
        @if (count($courses) > 0)
            @foreach ($courses as $course)
                <div
                    class="max-w-sm m-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-64 flex flex-col justify-center items-center">
                    <div class="p-5 text-center">
                        ...
                        <div class="w-50 mt-7 mb-5 bg-gray-200 rounded-full dark:bg-gray-700">
                            <div class="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full"
                                style="width: 45%"> 45%</div>
                        </div>


                        <div class="mt-4 container flex flex-wrap mx-auto mt-10 mb-10 justify-center items-center">F
                            <a href="{{ route('learning-page', $course->id) }}"
                            ...
                            <a href="mailto:{{ $course->email }}?subject=Question%20On%20{{ $course->course_name }}"
                                class="ml-9 inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Contact
                            </a>
                        </div>
                    </div>
